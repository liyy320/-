...
<%@ include file = "/_urc/inc/import.inc" %>
<html>
<head>
    <%@ include file = "/_urc/inc/title.inc" %>

    <style>

    	/*在页面顶部加载背景最佳，如有必要这块可以从数据库读取*/
        body{background-image: url(/<%=JGlobal.productName %>/_urc/images/bg_01.jpg);}
...
<body>
                ...
                <div class="winui-nav-tile">
                    ...
                    <div class="winui-tilebox">
                        ...
                        <div class="winui-tilebox-body">
                            ...
                            <div class="winui-tile winui-tile-normal">
                                <img src="/<%=JGlobal.productName %>/_urc/images/logo_100.png" />
                                <span>自定义图片</span>
                            </div>
                            <div class="winui-tile winui-tile-normal">
                                <i class="fa fa-file-text"></i>
                            ...
                            <div class="winui-tile winui-tile-normal">
                                <img src="/<%=JGlobal.productName %>/_urc/images/qzone_32.png" />
                                <span>QQ空间</span>
                            </div>
                            <div class="winui-tile winui-tile-normal">
    ...
    <!--layui.js-->
    <script src="/<%=JGlobal.productName %>/_urc/lib/layui/layui.js"></script>
    <script>
        layui.config({
            base: '/<%=JGlobal.productName %>/_urc/js/' //指定 index.js 路径
            , version: '1.0.0-beta'
        }).use('index');
