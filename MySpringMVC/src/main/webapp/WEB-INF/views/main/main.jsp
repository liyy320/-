...
<head>
    ...
    <title>Lyy-配置管理系统</title>
    <link href="/MySpringMVC/_urc/lib/layui/css/layui.css" rel="stylesheet" />
    <link href="/MySpringMVC/_urc/lib/animate/animate.min.css" rel="stylesheet" />
    <link href="/MySpringMVC/_urc/lib/font-awesome-4.7.0/css/font-awesome.css" rel="stylesheet" />
    <link href="/MySpringMVC/_urc/lib/winui/css/winui.css" rel="stylesheet" />
    <style>
        body
         {
            /*在页面顶部加载背景最佳，如有必要这块可以从数据库读取*/
            background-image: url(/MySpringMVC/_urc/images/bg_01.jpg);
        }
    </style>
</head>
<body>
                ...
                <div class="winui-nav-tile">
                    ...
                    <div class="winui-tilebox">
                        ...
                        <div class="winui-tilebox-body">
                            ...
                            <div class="winui-tile winui-tile-normal">
                                <img src="/MySpringMVC/_urc/images/logo_100.png" />
                                <span>自定义图片</span>
                            </div>
                            <div class="winui-tile winui-tile-normal">
                                <i class="fa fa-file-text"></i>
                            ...
                            <div class="winui-tile winui-tile-normal">
                                <img src="/MySpringMVC/_urc/images/qzone_32.png" />
                                <span>QQ空间</span>
                            </div>
                            <div class="winui-tile winui-tile-normal">
    ...
    <!--layui.js-->
    <script src="/MySpringMVC/_urc/lib/layui/layui.js"></script>
    <script>
        layui.config({
            base: '/MySpringMVC/_urc/js/' //指定 index.js 路径
            , version: '1.0.0-beta'
        }).use('index');
