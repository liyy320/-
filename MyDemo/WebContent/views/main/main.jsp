...
<head>
    ...
    <link href="/MyDemo/_urc/lib/animate/animate.min.css" rel="stylesheet" />
        ...
        body
         {
            ...
            background-image: url(/MyDemo/_urc/images/bg_01.jpg);
        }
    </style>
</head>
<body>
                ...
                <div class="winui-nav-tile">
                    ...
                    <div class="winui-tilebox">
                        ...
                        <div class="winui-tilebox-body">
                            ...
                            <div class="winui-tile winui-tile-normal">
                                <img src="/MyDemo/_urc/images/logo_100.png" />
                                <span>自定义图片</span>
                            </div>
                            <div class="winui-tile winui-tile-normal">
                                <i class="fa fa-file-text"></i>
                            ...
                            <div class="winui-tile winui-tile-normal">
                                <img src="/MyDemo/_urc/images/qzone_32.png" />
                                <span>QQ空间</span>
                            </div>
                            <div class="winui-tile winui-tile-normal">
    ...
    <script>
        layui.config({
            base: '/MyDemo/_urc/js/' //指定 index.js 路径
            , version: '1.0.0-beta'
        }).use('index');
