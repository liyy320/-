...
<link href="/MyDemo/_urc/jsp/login/login_1/css/style.css" type="text/css" rel="stylesheet" />
<script type="text/javascript" src="/MyDemo/_urc/jsp/login/login_1/js/canvas-particle.js"></script>
	...
	<div id="mydiv">
        <div class="login_box">
            <div class="login_font">
                <img src="/MyDemo/_urc/jsp/login/login_1/images/img_sm.png">
            </div>
