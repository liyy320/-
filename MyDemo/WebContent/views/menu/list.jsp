...
<script>
    layui.config({
        base: '/MyDemo/_urc/lib/winui/js/' //指定 winui 路径
        , version: '1.0.0-beta'
        ...
        table.render({
            id: tableId,
            elem: '#menuhtml',
            url: '/MyDemo/_urc/json/menulist.json',
        ...
        table.on('edit(menutable)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            if (/^[0-9]+$/.test(obj.value)) {
                ...
                $.ajax({
                    type: 'post',
                    url: '/MyDemo/_urc/api/menu/updatemenuorder',
        ...
        function openEditWindow(id) {
            ...
            $.ajax({
                type: 'get',
                url: '/MyDemo/views/menu/edit.jsp?id=' + id,
                async: true,
                success: function (data) {
                    layer.close(index);
                    content = data;
